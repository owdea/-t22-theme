...
<div class="weather-page-container">
    <div class="weather-page">
        ...
        <div class="weather-days-row">
            <swiper-container class="mySwiper" slides-per-view="auto" grab-cursor="true">
            <?php
            for ($i = 0; $i < 7; $i++) {
                    echo '<swiper-slide class="weather-day">';
                ...
                foreach ($cities as $city) {
                    ...
                    if (isset($fetched_data['cities_data'][$city_name])) {
                        ...
                        echo '<div class="city-weather-'.$city_name.' city-weather-forecast">';
                            ...
                            echo "</div>";
                            echo "<div class='city-weather-pin'>";
                                echo "<img src='" . get_template_directory_uri() . "/assets/icons/weather-pin.svg'>";
                            echo "</div>";
                        echo '</div>';
